...
<div class="row">
	<div class="container">
		...
		<div id="actions" class="form-horizontal">
			<div class="pull-left">
				<form id="searchForm" action="${SERVLET_COMPUTER_LIST}" method="GET"
					class="form-inline">
					<input type="search" id="${SEARCH_WORD}" name="${SEARCH_WORD}"
						class="form-control" placeholder="Search name" /> <input
						type="submit" id="${SUBMIT_SEARCH}" value="Search"
	...
	<form id="deleteForm" action="${SERVLET_COMPUTER_LIST}" method="POST">
	...
	<div class="row container text-center">
		<mytags:pagination
			...
			maxLinks="5" currPage="${requestScope[PAGINATION_CURRENT_PAGE]}"
