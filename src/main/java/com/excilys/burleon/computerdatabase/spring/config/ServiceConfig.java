...
@EnableCaching
@ComponentScan(basePackages = { "com.excilys.burleon.computerdatabase.service" })
public class ServiceConfig implements AsyncConfigurer {
    ...
    public AsyncUncaughtExceptionHandler getAsyncUncaughtExceptionHandler() {
        // You may customize the handler that manages exceptions thrown during
        // an asynchronous method execution
        // See
