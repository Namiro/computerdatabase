	...
	uri="http://www.springframework.org/security/tags"%>
				...
				class="glyphicon glyphicon-home"></span></a>
							...
							class="glyphicon glyphicon-log-out"></span> Logout</a>
                                                                                <!-- <button type="submit" value="Logout" class="nav btn btn-link"> 
								<span
							class="glyphicon glyphicon-log-out"> Logout</span>
									...
									<span aria-hidden="true">&times;</span>
										...
										code="computerlist_modal_signup_title" /></span>
                                                                                            <c:if test="${not empty requestScope[POPUP_MESSAGE_ERROR]}">
                                                                                                <label id="${POPUP_MESSAGE_ERROR}" class="alert alert-danger pull-right">${requestScope[POPUP_MESSAGE_ERROR]}</label>
                                                                                            </c:if>
                                                                                        </div>
                                                                        ...
                                                                        <%-- MODAL Login --%>
                                                                            <div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="gridSystemModalLabel" id="myModalLogin">
                                                                                <form class="form-horizontal" method="POST" action="${VIEW_AUTHENTICATION}">
                                                                                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
                                                                                    <div class="modal-dialog" role="document">
                                                                                        <div class="modal-content">
                                                                                            <div class="modal-header">
